...
> ⚠️ **Please note:**  
> The modules listed in this repository are not intended for active development. New features or modifications are **not** accepted.
...
| debugging | Folder for archived debugging modules. |
| docker | Folder for archived docker modules. |
| extension | Folder for archived extension modules. |
| image | Folder for archived image modules. |
| site | Folder for archived site modules. |
| software | Folder for archived software modules. |
| theme | Folder for archived theme modules. |
...
- **GitHub Issues** is the main platform for reporting bugs, asking questions, or submitting feature requests: [https://github.com/bugfishtm/suitefish-modules/issues](https://github.com/bugfishtm/suitefish-modules/issues)
